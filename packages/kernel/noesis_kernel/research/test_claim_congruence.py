"""Evidence Contract stage 2 — the claim-congruence flag (NOESIS_CLAIM_CONGRUENCE).
...
from noesis_kernel.research.budget import DEFAULT_MAX_LLM_CALLS, BudgetState
from noesis_kernel.research.react import AgentStep, ClaimOut, ComposedAnswer, VerifiedClaim, run_react
