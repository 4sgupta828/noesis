"""Evidence Contract stage 1 — the evidence-identity flag (NOESIS_EVIDENCE_IDENTITY).
...
from noesis_kernel.research.atoms import IDENTITY_INSTRUCTION, Atom, identity_tag
from noesis_kernel.research.budget import BudgetState
from noesis_kernel.research.react import AgentStep, ClaimOut, ComposedAnswer, run_react
...
def _run_claims_first(monkeypatch, *, evidence_identity: bool):
    ...
    captured: dict = {}
    import noesis_kernel.research.claims_first as cf
...
def test_extractor_batch_rendering_and_system_sentence():
    from noesis_kernel.research.claims_first import extract_claims
...
def test_entailment_items_rendering_with_and_without_tags():
    from noesis_kernel.research.claims_first import entail_claims
...
def _run_fallback(monkeypatch, *, evidence_identity: bool):
    ...
    captured: dict = {}
    import noesis_kernel.research.fallback_grounder as fg
