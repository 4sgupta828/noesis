"""Exploratory-legs extension (NOESIS_EXPLORE_LEGS) — Evidence Contract retrieval for
...
from noesis_kernel.research.contract import Contract, build_legs
from noesis_kernel.research.react import run_react
from noesis_kernel.research.test_question_contract import (
    _LEG_TEXT,
    _PROMPT,
    CountingSource,
    RecordingLLM,
