...
P2 (NOESIS_PANEL_DEDUP): pooled-claim dedup by (atom_id, normalized quote) + computed-convergence
annotation. P3 (NOESIS_PANEL_CONTRACT): ONE shared contract derived before the specialists (never
