"""Evidence Contract stage 3 — the question-contract flag (NOESIS_QUESTION_CONTRACT).
...
from noesis_kernel.research.contract import Contract, build_legs, derive_contract, match_entities
