...
- NON-DUPLICATION: the inline NOESIS_ANSWER_CHARTS path owns NUMERIC encodings (bar/line/pie of
  cited findings); NOESIS_ANSWER_VISUALS owns prose comparison TABLES / ranked lists. This subsystem
