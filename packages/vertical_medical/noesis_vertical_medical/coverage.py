...
SOURCE_INVENTORY = [
    ...
    {"key": "global_guidelines", "label": "Global guidelines (society/WHO/task-force)", "kind": "guidelines", "tier": "open", "status": "live", "note": "27 curated summaries + 26 FULL-TEXT guidelines via docling: KDIGO (CKD, anemia) + standard-of-care tranches 1-2 (~23 flagship management guidelines: GOLD COPD, ADA diabetes, WHO hypertension, Surviving Sepsis 2021, ATS/CDC TB, EACS HIV, CANMAT depression, EHF migraine, EULAR RA, ETA thyroid, BSG anemia, ...) fetched from datacenter-safe Europe PMC OA mirrors (society-site PDFs mostly 403 datacenter fetches); clinician review pending"},
