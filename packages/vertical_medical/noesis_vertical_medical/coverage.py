...
SOURCE_INVENTORY = [
    ...
    {"key": "global_guidelines", "label": "Global guidelines (society/WHO/task-force)", "kind": "guidelines", "tier": "open", "status": "live", "note": "27 curated summaries + FULL TEXT via docling: KDIGO (CKD, anemia) + standard-of-care tranche 1 (GOLD COPD, ADA diabetes, ATS/IDSA CAP, NHF/CSANZ ACS, BSR SLE) from datacenter-safe OA mirrors (society-site PDFs mostly 403 datacenter fetches); clinician review pending"},
