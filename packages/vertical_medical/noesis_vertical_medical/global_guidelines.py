...
GLOBAL_GUIDELINES: tuple[dict, ...] = (
    ...
    # ---- Standard-of-care full-text tranche 3 (2026-08-16): OA flagship GI/hepatology/pulm/endo/onc
    {"id": "aga-hpylori-2021-fulltext", "issuer": "American Gastroenterological Association",
     "title": "AGA Clinical Practice Update on the Management of Refractory Helicobacter pylori Infection: Expert Review (FULL TEXT)",
     "conditions": ['helicobacter pylori', 'h pylori', 'peptic ulcer', 'refractory h pylori', 'eradication therapy', 'quadruple therapy'],
     "url": "https://europepmc.org/articles/PMC8281326?pdf=render", "content_type": "application/pdf", "year": 2021},
    {"id": "wses-diverticulitis-2020-fulltext", "issuer": "World Society of Emergency Surgery",
     "title": "2020 update of the WSES guidelines for the management of acute colonic diverticulitis in the emergency setting (FULL TEXT)",
     "conditions": ['acute diverticulitis', 'colonic diverticulitis', 'diverticular disease', 'diverticulitis management', 'diverticular abscess'],
     "url": "https://europepmc.org/articles/PMC7206757?pdf=render", "content_type": "application/pdf", "year": 2020},
    {"id": "acg-cag-gib-2022-fulltext", "issuer": "ACG / Canadian Association of Gastroenterology",
     "title": "American College of Gastroenterology-Canadian Association of Gastroenterology Clinical Practice Guideline: Management of Anticoagulants and Antiplatelets During Acute Gastrointestinal Bleeding and the Periendoscopic Period (FULL TEXT)",
     "conditions": ['upper gastrointestinal bleeding', 'peptic ulcer bleeding', 'gi bleed', 'nonvariceal bleeding', 'endoscopic hemostasis'],
     "url": "https://europepmc.org/articles/PMC8966740?pdf=render", "content_type": "application/pdf", "year": 2022},
    {"id": "easl-masld-2024-fulltext", "issuer": "EASL-EASD-EASO",
     "title": "EASL-EASD-EASO Clinical Practice Guidelines on the Management of Metabolic Dysfunction-Associated Steatotic Liver Disease (MASLD) (FULL TEXT)",
     "conditions": ['mash', 'nash', 'masld', 'metabolic dysfunction associated steatotic liver disease', 'fatty liver', 'resmetirom', 'nafld'],
     "url": "https://europepmc.org/articles/PMC11299976?pdf=render", "content_type": "application/pdf", "year": 2024},
    {"id": "bsg-ibd-2020-fulltext", "issuer": "British Society of Gastroenterology",
     "title": "British Society of Gastroenterology guidance for management of inflammatory bowel disease during the COVID-19 pandemic (FULL TEXT)",
     "conditions": ['inflammatory bowel disease', 'ulcerative colitis', 'crohn disease', 'biologic ibd', 'mesalamine', 'azathioprine', 'ibd management'],
     "url": "https://europepmc.org/articles/PMC7211081?pdf=render", "content_type": "application/pdf", "year": 2020},
    {"id": "ats-niv-copd-2020-fulltext", "issuer": "American Thoracic Society",
     "title": "Long-Term Noninvasive Ventilation in Chronic Stable Hypercapnic Chronic Obstructive Pulmonary Disease. An Official American Thoracic Society Clinical Practice Guideline (FULL TEXT)",
     "conditions": ['chronic hypercapnic respiratory failure', 'noninvasive ventilation', 'home ventilation', 'copd respiratory failure', 'long term niv'],
     "url": "https://europepmc.org/articles/PMC7427384?pdf=render", "content_type": "application/pdf", "year": 2020},
    {"id": "eta-levothyroxine-2025-fulltext", "issuer": "European Thyroid Association",
     "title": "ETA guidelines for the use of levothyroxine sodium preparations in monotherapy to optimize the treatment of hypothyroidism (FULL TEXT)",
     "conditions": ['hypothyroidism', 'levothyroxine', 'thyroid hormone replacement', 'subclinical hypothyroidism', 'tsh', 'thyroid treatment'],
     "url": "https://europepmc.org/articles/PMC12323320?pdf=render", "content_type": "application/pdf", "year": 2025},
    {"id": "asccp-cervical-2019-fulltext", "issuer": "ASCCP",
     "title": "2019 ASCCP Risk-Based Management Consensus Guidelines for Abnormal Cervical Cancer Screening Tests and Cancer Precursors (FULL TEXT)",
     "conditions": ['cervical cancer screening', 'abnormal cervical cancer screening', 'hpv', 'colposcopy', 'cervical dysplasia', 'pap smear management'],
     "url": "https://europepmc.org/articles/PMC7147428?pdf=render", "content_type": "application/pdf", "year": 2020},
    {"id": "esoesmo-abc-breast-2020-fulltext", "issuer": "ESO-ESMO",
     "title": "5th ESO-ESMO international consensus guidelines for advanced breast cancer (ABC 5) (FULL TEXT)",
     "conditions": ['advanced breast cancer', 'metastatic breast cancer', 'breast cancer management', 'her2 breast cancer', 'endocrine therapy breast cancer'],
     "url": "https://europepmc.org/articles/PMC7510449?pdf=render", "content_type": "application/pdf", "year": 2020},
