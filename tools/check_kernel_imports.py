...
module importing noesis_vertical_* would couple the console to a cartridge).
...
KERNEL_ROOT = Path("packages/kernel/noesis_kernel")
FORBIDDEN_PREFIXES = ("noesis_vertical",)
