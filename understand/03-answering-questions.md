...
## 6. Claims-first comprehensive extraction (flag: `NOESIS_CLAIMS_FIRST`)
...
## 7. Evidence selection (flag: `NOESIS_EVIDENCE_SELECT`)
...
The streaming variant `/research/stream` (`app.py:497-539`, flag `NOESIS_STREAM`)
